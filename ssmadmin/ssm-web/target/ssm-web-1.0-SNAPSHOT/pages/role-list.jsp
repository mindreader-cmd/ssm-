...
<%--									<select class="form-control">&ndash;%&gt;--%>
<%--									<option>1</option>--%>
<%--									<option>2</option>--%>
<%--									<option>3</option>--%>
<%--									<option>4</option>--%>
...
<%--								</select> 条--%>
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								<li><a href="${pageContext.request.contextPath}/role/findAll.do?currentpage=1" aria-label="Previous">首页</a></li>
								<c:if test="${page.hasPreviousPage}">
									<li><a href="${pageContext.request.contextPath}/role/findAll.do?currentpage=${page.pageNum-1}">上一页</a></li>
								</c:if>
<%--								<li><a href="#">1</a></li>--%>
<%--								<li><a href="#">2</a></li>--%>
<%--								<li><a href="#">3</a></li>--%>
...
<%--								<li><a href="#">5</a></li>--%>
								<c:if test="${page.hasNextPage}">
									<li><a href="${pageContext.request.contextPath}/role/findAll.do?currentpage=${page.pageNum+1}">下一页</a></li>
								</c:if>
								<li><a href="${pageContext.request.contextPath}/role/findAll.do?currentpage=${page.pages}">尾页</a></li>
							</ul>
						</div>
